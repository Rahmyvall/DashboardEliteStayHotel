...
@section('content')
    ...
    <div class="container py-4">
        ...
        <div class="no-print d-flex justify-content-between mb-3">
            <div>
                ...
                <small class="text-muted">Invoice Hotel</small>
            </div>
        ...
        <div class="invoice-box shadow-sm">
            ...
            <div class="info-line"><b>Kode:</b> {{ $reservasi->kode_reservasi }}</div>

            <div class="info-line">
                <b>Status:</b>
                <span class="badge-status">{{ strtoupper($reservasi->status_reservasi) }}</span>
            </div>
            ...
            <div class="info-line">Kamar: {{ $reservasi->kamar->nomor_kamar ?? '-' }}</div>
            <div class="info-line">Check In: {{ $checkIn?->format('d M Y') ?? '-' }}</div>
            <div class="info-line">Check Out: {{ $checkOut?->format('d M Y') ?? '-' }}</div>
            <div class="info-line">Lama: {{ $lama }} malam</div>
            ...
            @if ($reservasi->catatan)
                ...
                <div class="info-line">{{ $reservasi->catatan }}</div>
            @endif
    ...
    {{-- FIX: pastikan barcode jalan setelah page ready --}}
