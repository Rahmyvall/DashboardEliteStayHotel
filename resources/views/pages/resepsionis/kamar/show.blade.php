    ...
    <div class="container-fluid px-4 py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-5">
            <div>
                ...
                <p class="text-muted mb-0">Informasi lengkap dan status kamar hotel</p>
            </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-5 col-xl-4">
                <div class="card border-0 shadow-sm rounded-4 h-100 overflow-hidden">
                    ...
                    <div
                        class="card-header border-0 py-5 text-center {{ $kamar->status_kamar === 'tersedia'
                            ? 'bg-success bg-opacity-10'
                            : ($kamar->status_kamar === 'terisi'
                                ? 'bg-danger bg-opacity-10'
                                : 'bg-warning bg-opacity-10') }}">

                        <div class="display-1 fw-bold mb-2 text-dark">
                            {{ $kamar->nomor_kamar }}
                        </div>
                        <div class="text-muted fs-5">Lantai {{ $kamar->lantai }}</div>
                    </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 h-100">
                    <div class="card-body p-5">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <div class="p-4 border rounded-3 h-100">
                                    <div class="text-muted small mb-2">Status Kamar</div>
                        ...
                        <div class="d-flex flex-wrap gap-3">
                            <a href="{{ route('resepsionis.kamar.index') }}"
                                class="btn btn-light border rounded-3 px-5 py-3">
                                <i class="fas fa-arrow-left me-2"></i> Kembali
                            </a>

                            <a href="{{ route('resepsionis.kamar.info', $kamar->id_kamar) }}"
                                class="btn btn-outline-primary rounded-3 px-5 py-3">
                                <i class="fas fa-info-circle me-2"></i> Info Lanjutan
                            </a>
