                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="catatan" rows="4"
                                ...
                                placeholder="Catatan tambahan saat proses check in">{{ old('catatan') }}</textarea>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const reservasiSelect =
        document.getElementById('id_reservasi');

    if (!reservasiSelect) return;

    function updatePreview() {

        const selected =
            reservasiSelect.options[reservasiSelect.selectedIndex];
    ...
    reservasiSelect.addEventListener('change', updatePreview);
